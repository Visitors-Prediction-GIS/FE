    ...
    <script>
        document.addEventListener("DOMContentLoaded", async () => {
            ...
            async function loadProvinces() {
                const res = await fetch("https://web-production-4f858.up.railway.app/api/provinces");
            ...
            async function updateCharts(prov) {
                ...
                const res = await fetch(`https://web-production-4f858.up.railway.app/api/forecast?province=${prov}`);
